                        ...
                        <nav class="navbar navbar-default zero_mp ">
                            ...
                            <div class="collapse navbar-collapse zero_mp" id="bs-example-navbar-collapse-1">
                                <ul class="nav navbar-nav navbar-right main_menu">
                                    ...
                                    <li class="active"><a href="karyawan.php">Karyawan <span class="sr-only">(current)</span></a></li>
  ...
  <?php
    ...
    if(mysqli_num_rows($result) > 0){
      while ($row= mysqli_fetch_array($result)){
        echo "<center> <h2 style=\"font-family: 'Kaushan Script', cursive;\">"."<b>"."<a style=\"color:black; decoration:none;\" href='isi.php?id=".$row['id']."'>".ucwords($row["nama"])."</b>"."</h2>"."<br></centre>";
        echo "<b style=\"font-size:15px;\" class=\"label label-success\">".$row["jabatan"]." || ".$row["tim"]."</b>"."<br>";
        echo "<center>"."<img style=\"margin: 5px; width: 20%;\" src='../admin/cover/".$row['cover']."'>"."</center>"."<br>"; //baris 2
        echo "<p align=justify>".substr($row["email"],0,350)."</p>";
      }
    }else{
